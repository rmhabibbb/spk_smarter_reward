        ...
        <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ol class="breadcrumb breadcrumb-bg-indigo align-left">
                        ...
                        <li> <a href="<?=base_url('kabag/kriteria')?>"><i class="material-icons">view_list</i> Kelola Data Kriteria</a> </li> 
                                              ...
                                              <td>
                                                <?php if ($n <= 1) {
                                                 ...
                                                 <?php if ($row->prioritas != $min_prio) { ?>
                                                    <a href="<?=base_url('kabag/subup/'.$row->prioritas.'/'.$row->id_kriteria)?>"> 
                                                  ...
                                                  <?php if ($row->prioritas != $max_prio) { ?>
                                                    <a href="<?=base_url('kabag/subdown/'.$row->prioritas.'/'.$row->id_kriteria)?>"> 
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?= base_url('kabag/kriteria')?>" method="Post"  >   
...
<div class="modal fade" id="tambahsub" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('kabag/subkriteria')?>" method="Post"  >  
