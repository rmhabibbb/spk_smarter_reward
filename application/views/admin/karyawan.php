        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12   col-sm-12  col-md-12   col-lg-12 ">
                <ol class="breadcrumb breadcrumb-bg-indigo align-left">
                    ...
                    <li> <i class="material-icons">assignment_ind</i> Kelola Data Karyawan </li> 
                </ol>
                <div class="card"> 
                        <div class="body">

                        <a    href="<?=base_url('admin/formkaryawan')?>"><button class="btn bg-indigo">Tambah Karyawan</button></a> 
                        <br><br>
                                              ...
                                              <td> <?=$row->no_hp?></td>    
                                               <td>
                                                  <a href="<?=base_url('admin/Karyawan/'.$row->id_karyawan)?>"> 
                                                   ...
                                                   <a data-toggle="modal" data-target="#delete-<?=$row->id_karyawan?>"  href=""><button class="btn bg-red btn-block">Hapus</button></a>
                                               </td>        
                                          </tr>
                                      <?php endforeach; ?>
                                    </tbody>
